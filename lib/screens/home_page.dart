...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: PopScope(
        canPop: _selectedCategory != '♥ Favourites' || _selectedFavoriteCategory == null,
        onPopInvoked: (didPop) {
          if (didPop) return;
                ...
                SizedBox(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      List<String> categories = ['♥ Favourites'];
                      if (snapshot.hasData) {
